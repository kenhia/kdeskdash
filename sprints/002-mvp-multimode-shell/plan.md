...
status: active
date: 2026-06-06
origin: sprints/002-mvp-multimode-shell/requirements.md
---
...
(see origin: sprints/002-mvp-multimode-shell/requirements.md). It also
...
- `docs/solutions/` is currently empty; the pre-MVP plan
  (`sprints/001-premvp-display-touch/plan.md`) records that the panel
